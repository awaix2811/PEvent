                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: event.imgUrl.isNotEmpty
                            ...
                            : const AssetImage(ImageAssets.eventImgs),
                        fit: BoxFit.cover,
                      ),
                    ),
                    child: Padding(
                      padding:
                          EdgeInsets.only(top: 39.h, left: 12.w, right: 12.w),
                      child: Align(
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        boxShadow: [
                          BoxShadow(
                            color: const Color(0xff5A5A5A1A).withOpacity(0.1),
                            blurRadius: 20,
                            spreadRadius: 0,
                          ...
                          SizedBox(
                            ...
                            child: Stack(
                              children: const [
                                CircleAvatar(
                                  backgroundImage:
                                      AssetImage(ImageAssets.oneImg),
                                ),
                                Positioned(
                                  left: 22,
                                  child: CircleAvatar(
                                    backgroundImage:
                                        AssetImage(ImageAssets.twoImg),
                                  ),
                                ),
                                Positioned(
                                  left: 44,
